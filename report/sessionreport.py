...
class MakeAndSavePlots():
  ...
  def _mainPlot(self, session_df):
    ...
    animal_name = session_df.Name.unique()[0]
    psych_plotter = analysis.Plotter(axes_or_graph_obj=axs[0][0])
    analysis.psychAxes(animal_name, psych_plotter)
    analysis.psychAnimalSessions(session_df, animal_name, psych_plotter,
                                 analysis.METHOD)

    perf_plotter1 = analysis.Plotter(axes_or_graph_obj=axs[0][1])
    ...
    analysis.performanceOverTime(session_df, single_session=True,
                                 ...
                                 draw_plots=[Plot.Performance,
                                             ...
                                             Plot.ReactionT,
                                             Plot.StimAPO])
    perf_plotter2 = analysis.Plotter(axes_or_graph_obj=axs[1][1])
    analysis.performanceOverTime(session_df, single_session=True,
    ...
    trial_plotter = analysis.Plotter(axes_or_graph_obj=axs[1][0])
